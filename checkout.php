            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="checkout-right">
                  ...
                  {
                    if((count($_SESSION['cart']))!=0 && isset($_SESSION['loginstatus']))
                    {
                      $click='';
                    }
                  ?>
                  <div class="aa-order-summary-area">
                    <table class="table table-responsive">
                      ...
                      <tbody>
                        ...
                        ?>
                        <tr>
                          <td><?php echo $list['name']; ?> <strong> x <?php echo $list['quantity']; ?></strong></td>
                          <td>Rs. <?php echo ($list['price']*$list['quantity']);?></td>
                        </tr>
                        <?php 
                         $subtotal=$subtotal+($list['price']*$list['quantity']);
                        }
                        ?>
                        <!--<tr>
                  ...
                  <div class="aa-payment-method">                    
                    ...
                    <input type="submit" value="Place Order" class="aa-browse-btn" <?php echo $click; ?>>                
                  </div>
                </div>
              </div>
            </div>
